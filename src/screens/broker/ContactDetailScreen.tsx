...
import {
  View, Text, ScrollView, TouchableOpacity, Image, Linking, StyleSheet,
} from 'react-native';
          ...
          <View style={styles.section}>
            ...
            <View style={styles.infoCard}>
              <View style={styles.dpGrid}>
                {[
                  { label: 'Sqft', value: `${contact.desiredProperty.minSqft.toLocaleString()}–${contact.desiredProperty.maxSqft.toLocaleString()}` },
                  { label: 'Beds', value: `${contact.desiredProperty.beds}+` },
                  { label: 'Baths', value: `${contact.desiredProperty.baths}+` },
                  { label: 'Type', value: contact.desiredProperty.propertyType },
              ...
              <View style={[styles.infoRow, { marginTop: 8 }]}>
                <Ionicons name="location-outline" size={16} color={Colors.textMuted} />
                <Text style={styles.infoText}>{contact.desiredProperty.city}</Text>
              </View>
            </View>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, marginBottom: Spacing.md, borderWidth: 3, borderColor: Colors.primary },
