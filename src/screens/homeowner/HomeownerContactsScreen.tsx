    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      ...
      <View style={[styles.sheet, { backgroundColor: C.bgSurface, borderTopColor: C.bgBorder }]}>
        ...
        <TextInput
          ...
          placeholderTextColor={C.textMuted}
          style={[styles.fieldInput, styles.notesInput, { backgroundColor: C.bgElevated, borderColor: C.bgBorder, color: C.textPrimary }]}
        />
        <TouchableOpacity
  ...
  return (
    <View style={[styles.screen, { backgroundColor: C.bgBase }]}>
      <View style={styles.searchPad}>
        <View style={[styles.searchBox, { backgroundColor: C.bgSurface, borderColor: C.bgBorder }]}>
      ...
      >
        ...
        {filtered.length === 0
          ? <View style={[styles.empty, { backgroundColor: C.bgSurface, borderColor: C.bgBorder }]}>
              ...
              <Text style={[Typography.sm, { color: C.textMuted, marginTop: Spacing.sm }]}>No contacts found.</Text>
            </View>
          : filtered.map(c => (
              <ContactRow
                key={c.id}
...
const styles = StyleSheet.create({
  ...
  searchPad:  { padding: Spacing.md, paddingBottom: Spacing.sm },
  ...
  fieldLabel:  { fontSize: 11, fontWeight: '600', letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 5 },
